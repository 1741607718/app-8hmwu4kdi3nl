...
function makeApiRequest(url: string, data: any, headers: any): Promise<any> {
...
async function testApiParameters() {
  ...
  try {
    ...
    console.log('❌ 基本查询失败:', (error as Error).message);
  }
  ...
  try {
    ...
    console.log('❌ 日期范围查询（格式1）失败:', (error as Error).message);
  }
  ...
  try {
    ...
    console.log('❌ 日期范围查询（格式2）失败:', (error as Error).message);
  }
  ...
  try {
    ...
    console.log('❌ 日期范围查询（格式3）失败:', (error as Error).message);
  }
  ...
  try {
    ...
    console.log('❌ 车辆登记API基本查询失败:', (error as Error).message);
  }
  ...
  try {
    ...
    console.log('❌ 车辆登记API日期范围查询失败:', (error as Error).message);
  }
  ...
  try {
    ...
    console.log('❌ 最小查询失败:', (error as Error).message);
  }
